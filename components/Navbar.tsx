            ...
            >
              <div className="relative shrink-0">
                <Image
                  ...
                  unoptimized
                  quality={100}
                  className="block h-12 w-auto max-w-[min(78vw,220px)] object-contain object-start drop-shadow-[0_4px_12px_rgba(0,0,0,0.35)] [image-rendering:high-quality] sm:h-[3.35rem] sm:max-w-[min(72vw,260px)] md:h-[3.5rem] lg:h-[4.5rem] lg:max-w-[min(42vw,380px)] xl:h-[5rem] xl:max-w-[min(40vw,440px)] 2xl:h-[5.25rem] 2xl:max-w-[480px]"
                  priority
