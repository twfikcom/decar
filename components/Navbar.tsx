    ...
    <header id="site-navbar" className="w-full flex flex-col z-[100] relative">
      ...
      <div className="bg-black shadow-[0_10px_30px_rgba(0,0,0,0.5)] border-b-[4px] border-red-600 sticky top-0 z-50">
        <div className="mx-auto max-w-7xl ps-2 pe-3 sm:ps-3 sm:pe-5 lg:ps-4 lg:pe-6">
          ...
          <div className="grid min-h-[5rem] w-full grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-2 overflow-visible py-1.5 sm:gap-3 sm:py-2 lg:min-h-[5.75rem] lg:gap-3 lg:py-2.5 xl:min-h-[6.25rem]">
            <Link
              href="/"
