...
export const CATEGORY_STRIP_ICON_URLS = {
  ...
  aufbau: 'https://admin.xn--lwetrucks-07a.de/pics/sizeL_Trucks%20with%20body.png',
  kipper: 'https://admin.xn--lwetrucks-07a.de/pics/11111.webp',
  kasten: 'https://admin.xn--lwetrucks-07a.de/pics/111.webp',
  /** Trailers / semitrailers (Auflieger) — flat icon on black; strip uses blend mode. */
  trailers: 'https://admin.xn--lwetrucks-07a.de/pics/sizeL_Trailers.png',
